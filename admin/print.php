...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>MONGGO SARE</p>
				<p>Pabelan Utara<br>Surakarta<br>IndonesiaS</p>
				<p>(+0625) 222 333 333</p>
			</address>
			<span><img alt="" src="assets/img/monggo.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			<h1><span >Thanks for coming/span></h1>
			<div >
				<p align="center">Email :- info@monggo.com || Web :- www.monggosare.com || Phone :- (+0625) 222 333 333 </p>
			</div>
		</aside>
	</body>
</html>
