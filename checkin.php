...
<?php
		if(!isset($_GET["rid"]))
		{
			 ...
			 header("location:index.php");
				...
				$sql ="SELECT * from roombook where FName = '$guest'";
							...
							if($st=="Conform")
							{
								...
								if($f1=="NO" )
								{
									...
									else if ($f3 == "NO")
									{
										...
										else if( mysqli_query($koneksi,$urb))
											{	
